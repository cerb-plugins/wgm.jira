...
<div class="cerb-profile-toolbar">
	<form class="toolbar" action="{devblocks_url}{/devblocks_url}" onsubmit="return false;" style="margin-bottom:5px;">
		...
		<!-- Edit -->
		<button type="button" id="btnDisplayJiraProjectEdit" title="{'common.edit'|devblocks_translate|capitalize}">&nbsp;<span class="cerb-sprite2 sprite-gear"></span>&nbsp;</button>
	</form>
...
<script type="text/javascript">
	$(function() {
		var tabs = $("#jira_projectTabs").tabs( { selected:{$tab_selected_idx} } );
